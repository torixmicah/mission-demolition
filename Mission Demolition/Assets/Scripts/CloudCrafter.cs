...
public class CloudCrafter : MonoBehaviour
{
    ...
    public bool ______________________________________________________;
    ...
    private void Awake()
    {
        ...
        for (int i=0; i<numClouds; i++)
        {
            ...
            // Random.Range will not eve pick as high as the top number
    ...
    private void Update()
    {
        ...
        foreach(GameObject cloud in cloudInstances)
        {
            ...
            // If a cloud has moved too far t the left...
